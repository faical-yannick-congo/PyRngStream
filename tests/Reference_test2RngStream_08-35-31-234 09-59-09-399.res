...
Reset stream g2 to the beginning of Substream.
 ...
 Sum of 100000 values from stream g2 with double precision:   
  50098.2241

 Sum of 100000 antithetic output values from stream g3:   
  49960.8763
...
swig/python detected a memory leak of type 'RngStream *', no destructor found.
swig/python detected a memory leak of type 'RngStream *', no destructor found.
swig/python detected a memory leak of type 'RngStream *', no destructor found.
swig/python detected a memory leak of type 'RngStream *', no destructor found.
swig/python detected a memory leak of type 'RngStream *', no destructor found.
